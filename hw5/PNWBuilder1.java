...
public class PNWBuilder
{
   ...
   */
   ...
   p1.matrix = Matrix.translate(
          xTranslation,
          yTranslation,
          zTranslation);

      p2.matrix = Matrix.translate(
                                xTranslation,
                                yTranslation,
                                zTranslation);
      p3.matrix = Matrix.translate(
                                xTranslation,
                                yTranslation,
                                zTranslation);
      p4.matrix = Matrix.translate(
                                xTranslation,
                                yTranslation,
                                zTranslation);
  ...
  currentPosition = p2;
   ...
   currentPosition = scene.positionList.get(1).getNestedPosition(2);
      ...
      currentPosition.matrix.mult(Matrix.translate(
                                         ...
                                         yTranslation,
                                         zTranslation));
      currentPosition.matrix.mult(Matrix.rotateX(xRotation));
      currentPosition.matrix.mult(Matrix.rotateY(yRotation));
      currentPosition.matrix.mult(Matrix.rotateZ(zRotation));
      currentPosition.matrix.mult(Matrix.scale(scale));
