...
public class PNWBuilder
{
   ...
   private double[] xTranslation = new double[] {0,-1.5,0,1.5};
   private double[] yTranslation = new double[] {0,0,0,0};
   private double[] zTranslation = new double[] {distanceToCamera+1,distanceToCamera+1,distanceToCamera+1,distanceToCamera+1};
   ...
   */
   public PNWBuilder()
   {
	  ...
	  // Position p2 = new Position(new P());
	  // Position p3 = new Position(new N());
	  // Position p4 = new Position(new W());

	  p1.addNestedPosition(new Position(new P()));
	  p1.addNestedPosition(new Position(new N()));
	  p1.addNestedPosition(new Position(new W()));

	  scene.addPosition(p1);

      ModelShading.setRandomColor(p1.getNestedPosition(0).model);
      ModelShading.setRandomColor(p1.getNestedPosition(1).model);
      ModelShading.setRandomColor(p1.getNestedPosition(2).model);
	  ...
	  p1.getNestedPosition(0).matrix = Matrix.translate(
		  						xTranslation[1],
		  						yTranslation[1],
		  						zTranslation[1]);

      p1.getNestedPosition(1).matrix = Matrix.translate(
                                xTranslation[2],
                                yTranslation[2],
                                zTranslation[2]);
      p1.getNestedPosition(2).matrix = Matrix.translate(
                                xTranslation[3],
                                yTranslation[3],
                                zTranslation[3]);
   ...
   @Override public void keyTyped(KeyEvent e)
   {
      ...
      else if ('/' == c)
      {
         ...
         if (0 == modelIndex)
         {
            ...
            currentPosition = scene.positionList.get(1);

         }
         else if (1 == modelIndex)
         {
            System.out.println("Working on P.");
            currentPosition = scene.positionList.get(1).getNestedPosition(0);

         }
         else if (2 == modelIndex)
         {
            System.out.println("Working on N.");
            currentPosition = scene.positionList.get(1).getNestedPosition(1);

         }
         else if (3 == modelIndex)
         {
            System.out.println("Working on W.");
			currentPosition = scene.positionList.get(1).getNestedPosition(2);
         }
      }
      else if ('a' == c)
      {
