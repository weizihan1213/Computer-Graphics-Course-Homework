...
public class FrameBuffer
{
   ...
   */
   public void setViewport(int vp_ul_x, int vp_ul_y, int width, int height) {
      this.vp = this.new Viewport(vp_ul_x, vp_ul_y, width, height);
   }
   ...
   public class Viewport  // inner class (non-static nested class)
   {
      ...
      */
      public Viewport(int vp_ul_x, int vp_ul_y, FrameBuffer sourceFB) {
         this(vp_ul_x, vp_ul_y, sourceFB.width, sourceFB.height, bgColorFB);
      ...
      */
      public Viewport(int vp_ul_x, int vp_ul_y, Viewport sourceVP) {
         this(vp_ul_x, vp_ul_y, sourceVP.getWidth(), sourceVP.getHeight(), bgColorFB);
